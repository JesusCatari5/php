...
$sec  = Sector_5::getAll();
/*----------------------------------- */
$img = Sector_5::get_Prefijo("imagen_1");
$img2 = Sector_5::get_Prefijo("imagen_2");
$img3 = Sector_5::get_Prefijo("imagen_3");
$img4 = Sector_5::get_Prefijo("imagen_4");
$img5 = Sector_5::get_Prefijo("imagen_5");
...
<?php
if (count($sec) > 0) : ?>
  <form method="post" action="index.php?accion=todo/sector_5" enctype="multipart/form-data" style="margin-top: -1em;">
          ...
          <tr>
            <th>
              ...
              <li class=""><a href="index.php?vista=home" style="color: black;">Banner</a></li>
                ...
                <li class="active" style="background-color: #605ca8;color: white;"><a href="index.php?vista=sector_5" style="color: black;">Nuevo Reporte</a></li>
