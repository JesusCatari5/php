...
$sec  = Sector_4::getAll();
/*----------------------------------- */
$img = Sector_4::get_Prefijo("imagen_1");
$img2 = Sector_4::get_Prefijo("imagen_2");
$img3 = Sector_4::get_Prefijo("imagen_3");
$img4 = Sector_4::get_Prefijo("imagen_4");
$img5 = Sector_4::get_Prefijo("imagen_5");
...
<?php
if (count($sec) > 0) : ?>
  <form method="post" action="index.php?accion=todo/sector_4" enctype="multipart/form-data" style="margin-top: -1em;">
          ...
          <tr>
            <th>
              <ul class="nav nav-tabs">
                ...
                <li class="active" style="background-color: #605ca8;color: white;"><a href="index.php?vista=sector_4" style="color: black;">Ultima Noticia</a></li>
