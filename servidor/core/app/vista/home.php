...
<?php
if (count($sec) > 0) : ?>
  <form method="post" action="index.php?accion=todo/sector_1" enctype="multipart/form-data" style="margin-top: -1em;">
          ...
          <tr>
            <th>
              <ul class="nav nav-tabs">
                <li class="active" style="background-color: #605ca8;color: white;"><a href="index.php"> Banner</a></li>
