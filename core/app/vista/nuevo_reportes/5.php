...
$img1_t = Sector_5::get_Prefijo("imagen_5");
...
<head>
    <title>
        ...
        <?php
        $a = Sector_5::get_Prefijo("titulo_5");
        ?>
        <?= $a->valor; ?>
    </title>
</head>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <div class="blogtext">
                                ...
                                <div class="blogmetas">
                                    <ul>
                                        <li><i class="fa fa-calendar"></i>
                                            ...
                                            <?php
                                            $a = Sector_5::get_Prefijo("fecha_5");
                                            ?>
                                        ...
                                        <li>
                                            ...
                                            <a href="#">
                                                ...
                                                <?php
                                                $a = Sector_5::get_Prefijo("lugar_5");
                                                ?>
                                                <?= $a->valor; ?>
                                ...
                                <p>
                                    ...
                                    <?php
                                    $a = Sector_5::get_Prefijo("mensaje_5");
                                    ?>
                                    <?= $a->valor; ?>
