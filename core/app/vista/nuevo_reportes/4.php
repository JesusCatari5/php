...
$sec4  = Sector_5::getAll();
$img1_t = Sector_5::get_Prefijo("imagen_4");
...
<head>
    <title>
        ...
        <?php
        $a = Sector_5::get_Prefijo("titulo_4");
        ?>
        <?= $a->valor; ?>
    </title>
</head>
    ...
    <div class="custom-container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -3.5em;">
                <ol class="breadcrumb">
                    <li><a href="index.php">Nuevo</a></li>
                    <li class="active">
                        Reportes
                    </li>
                </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <div class="blogtext">
                                ...
                                <div class="blogmetas">
                                    <ul>
                                        <li><i class="fa fa-calendar"></i>
                                            ...
                                            <?php
                                            $a = Sector_5::get_Prefijo("fecha_4");
                                            ?>
                                        ...
                                        <li>
                                            ...
                                            <a href="#">
                                                ...
                                                <?php
                                                $a = Sector_5::get_Prefijo("lugar_4");
                                                ?>
                                                <?= $a->valor; ?>
                                ...
                                <div class="item">
                                    <center>
                                        <img src="servidor/style/portada/<?= $img1_t->valor; ?>" style="width: 38.4em;">
                                    </center>
                                ...
                                <p>
                                    ...
                                    <?php
                                    $a = Sector_5::get_Prefijo("mensaje_4");
                                    ?>
                                    <?= $a->valor; ?>
