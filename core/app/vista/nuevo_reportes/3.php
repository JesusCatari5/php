...
$img1_t = Sector_5::get_Prefijo("imagen_3");
...
<head>
    <title>
        <?php
        $a = Sector_5::get_Prefijo("titulo_3");
        ?>
        <?= $a->valor; ?>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <div class="blogtext">
                                ...
                                <div class="blogmetas">
                                    <ul>
                                        <li><i class="fa fa-calendar"></i>
                                            ...
                                            <?php
                                            $a = Sector_5::get_Prefijo("fecha_3");
                                            ?>
                                        ...
                                        <li>
                                            ...
                                            <a href="#">
                                                ...
                                                <?php
                                                $a = Sector_5::get_Prefijo("lugar_3");
                                                ?>
                                                <?= $a->valor; ?>
                                ...
                                <p>
                                    ...
                                    <?php
                                    $a = Sector_5::get_Prefijo("mensaje_3");
                                    ?>
                                    <?= $a->valor; ?>
