<?php
$sec  = Sector_1::getAll();
$img = Sector_1::get_Prefijo("imagen_2");
               ...
               <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                     <div class="blogtext">
                        ...
                        <div class="blogmetas">
                           <ul>
                              <li><i class="fa fa-calendar"></i>
                                 ...
                                 <?php
                                 $a = Sector_1::get_Prefijo("fecha_2");
                                 ?>
                        ...
                        <div class="item">
                           <center>
                              <img src="servidor/style/portada/<?= $img->valor; ?>" style="width: 38.4em;">


                           </center>

                           <!--a href="javascript:var dir=window.document.URL;var tit=window.document.title;var tit2=encodeURIComponent(tit);var dir2= encodeURIComponent(dir);window.location.href=('http://www.facebook.com/sharer.php?u=www.fidestarija.com/index.php?vista=banner/1/?u='+dir2+'&amp;t='+tit2+'');" target="top_"><img src="style/images/facebook.png" width="30" height="30" alt="Compartir"></a>
                           <a href="https://web.whatsapp.com/send?text=https://www.fidestarija.com/index.php?vista=banner/1" target="top_"><img src="style/images/whatsApp.png" width="30" height="30" alt="Compartir"></a>
                           <a href="https://www.instagram.com/fidesbermejo/" target="top_"><img src="style/images/instagram.png" width="30" height="30" alt="Compartir"></a-->
                           ...
                           <p>
                              ...
                              <?php
                              $a = Sector_1::get_Prefijo("comentario_2");
                              ?>
                              <?= $a->valor; ?>
